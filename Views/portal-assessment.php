                ...
                <div class="app-main__inner">
                    ...
                    <div class="app-mainpage">
                        <div class="row">
                            ...
                            <div class="main-card mb-15p card card-timeline">
                                <div class="card-header">Assessments
                                    <div class="btn-actions-pane-right">
                                        <a data-toggle="modal" data-target="#new-assessment" href="#" class="btn btn-primary">New Assessment</a> <!-- portal-new-assessment.php -->
