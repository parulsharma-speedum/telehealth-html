                ...
                <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-left">
                        ...
                        <div class="widget-subheading">
                            <div>By Johnny
                                <div class="badge badge-pill badge-primary ml-2">NEW</div>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content-right widget-content-actions">
            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-right ml-3">
                        <div class="badge badge-pill badge-info">Latest Task</div>
                    </div>
                </div>
            </div>
        </li>
            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-right">
                        <div class="badge badge-theme-yellow mr-2">69</div>
                    </div>
                    <div class="widget-content-right">
                        <button class="border-0 btn-transition btn btn-outline-info">
                            <i class="fa fa-check"></i>
