...
<!--TABLES -->
<!--DataTables-->
<script src="../js/datatable/jquery.dataTables.min.js" crossorigin="anonymous"></script>
<script src="../js/datatable/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
<script src="../js/datatable/dataTables.responsive.min.js" crossorigin="anonymous"></script>
<script src="../js/datatable/responsive.bootstrap.min.js" crossorigin="anonymous"></script>
