                                ...
                                <div class="card-body">
                                    <div class="card-border border-muted card card-body mb-3">
                                        <div class="row">
                                            ...
                                            <select style="width:100%" id="select-cat" multiple="true" class="select2-custom">
                                              <option value=""></option>
...
<!--                                             <select multiple="multiple" class="multiselect-dropdown form-control form-control-sm">
                                            ...
                                            <select style="width:100%" id="select-type" multiple="true" class="select2-custom">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" onclick="location.href='portal-order-review.php'" class="btn btn-primary">Next</button>
                                </div>
                            </div>
                            </div>
                        </div>
