...
<!-- /*Add Support Member*/ -->
    ...
    $(document).ready(function() {
        $("#apm-doctorselection button").click(function(){
            ...
            $("#apm-selected").append("<a href='javascript:void(0);' class='fa-xs mb-2 mr-2 btn-pill btn btn-sm badge-outline-yellow'>"+selectedDoctor+"<i class='fa fa-times ml-1'></i></a>");
